            ...
            <div class="table-responsive">
                ...
                <table class="table zero-configuration">
                    ...
                    @foreach($package as $row)
                        <tr>
                            <td>
                                <a href="/admin/sub-package/{{$row->id}}">{{$row->package_name}}</a>
                            </td>
...
function Delete(id){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/sub-package-delete/'+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
