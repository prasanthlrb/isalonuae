...
@section('body-section')
 <div class="content-overlay"></div>
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">App Beauty Clinic List</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="/admin/dashboard"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item active">App Beauty Clinic
                                    </li>
                                </ol>
                            </div>
                        </div>
        ...
        <button id="add_new" style="width: 300px;" type="button" class="btn btn-primary add-task-btn btn-block my-1">
          ...
          <span>New App Beauty Clinic</span>
        </button>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="id" id="id">
                    ...
                    <div class="form-group">
                      <label>Select the Beauty Clinic</label>
...
$('#add_new').click(function(){
    ...
    $('#modal-title').text('Add App Beauty Clinic');
    $('#salon_id').select2();
});
...
function Delete(id){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/app-beauty-delete/'+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
