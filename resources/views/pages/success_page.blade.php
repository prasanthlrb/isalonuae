                ...
                <div class="col-md-12 col-12 px-0">
                    <div class="card disable-rounded-right mb-0 p-2">
                        <div class="card-header pb-1">
                            ...
                            <center>
                                <img style="width: 200px;height: 200px;margin-bottom: 20px;" class="img-fluid" src="/images/logo/logo1.png" alt="branding logo">
                            </center>
                            </div>
                        </div>
                        <div class="card-content">
                            ...
                            <div class="text-center mb-2">
                                <h4 class="text-center mb-2" style="color: #f4a440">Your Payment was Successfull</h4>
                            </div>

                                <form class="mb-2" action="/">
                                    <button type="submit" class="btn btn-primary glow position-relative w-100">Go to Order Page<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
