...
@section('body-section')
 <div class="content-overlay"></div>
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">App Home Services List</h5>
        ...
        <button id="add_new" style="width: 300px;" type="button" class="btn btn-primary add-task-btn btn-block my-1">
          ...
          <span>New App Home Services</span>
        </button>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input value="{{$city->id}}" type="hidden" name="city_id" id="city_id">
                    ...
                    <div class="form-group">
                      <label>Select the Home Services</label>
...
$('#add_new').click(function(){
    ...
    $('#modal-title').text('Add App Home Services');
    $('#salon_id').select2();
});
